...
import Listenewartice from "./Home";
...
const App = () => {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Listenewartice">
      <Stack.Screen
          name="updatearticle"
          component={updatearticle}
          options={{
            title: ' update article', //Set Header Title
            headerStyle: {
      ...
      <Stack.Screen
          ...
          options={{
            title: 'Choose location', //Set Header Title
            headerStyle: {
              backgroundColor: '#f4511e', //Set Header color
            },
            headerTintColor: '#fff', //Set Header text color
      ...
      <Stack.Screen
          name="Listenewartice"
          component={Listenewartice}
          options={{
            title: 'Liste new artice', //Set Header Title
            headerStyle: {
              backgroundColor: '#f4511e', //Set Header color
            },
            headerTintColor: '#fff', //Set Header text color
        ...
        />
          ...
          options={{
            title: 'add article', //Set Header Title
            headerStyle: {
              backgroundColor: '#f4511e', //Set Header color
            },
            headerTintColor: '#fff', //Set Header text color
        ...
        <Stack.Screen
          ...
          options={{
            title: 'Parmertes', //Set Header Title
            headerStyle: {
              backgroundColor: '#f4511e', //Set Header color
            },
            headerTintColor: '#fff', //Set Header text color
